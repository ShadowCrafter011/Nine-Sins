...
function startscreen() {
  ...
  let { Xswell, Yswell, swellsize, swelltrue } = difficulty
  let t = difficulty.swelltime
  if (swelltrue == true) {

    c.fillStyle = "rgba(255,255,255)"
    c.fillRect(Xswell - swellsize * t, Yswell - swellsize * t, swellsize * 2 * t + xw, swellsize * 2 * t + yw)
    if (difficulty.swelltime < 1) {
      difficulty.swelltime += timeSec * 10
    }
  } else {
    difficulty.swelltime = 0
  }
